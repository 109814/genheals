...
<style>
    ...
    .card-latihan:hover {
        ...
        box-shadow: 0 15px 30px rgba(255, 75, 130, 0.15);
    }
    ...
    .card-treatment:hover {
        ...
        box-shadow: 0 15px 25px rgba(197, 31, 93, 0.1);
    ...
    .card-treatment:hover .btn-circle-dark {
        background-color: var(--color-primary);
        transform: scale(1.1);
    }
    ...
    .body-focus-link:hover .focus-circle {
        border-color: var(--color-primary);
        transform: scale(1.05);
        box-shadow: 0 10px 20px rgba(197, 31, 93, 0.2);
    }

    .body-focus-link:hover h6 {
        color: var(--color-primary);
    }
    ...
    .water-tracker-box {
        ...
        border-radius: 25px;
        padding: 40px 20px;
        box-shadow: 0 10px 30px rgba(197, 31, 93, 0.08);
    }
...
<main class="mb-5 fade-in-up delay-1">
    <div class="container">
        ...
        <ul class="nav nav-tabs mb-5 flex-nowrap overflow-auto pb-2" id="latihanTab" role="tablist"
            style="white-space: nowrap;">
            <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tantangan"
                    type="button">Tantangan</button></li>
            <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#perawatan"
                    type="button">Perawatan Wajah</button></li>
            <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#fokus"
                    type="button">Fokus Tubuh</button></li>
            <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#pelacak"
                    type="button"><i class="bi bi-droplet-fill me-1"></i> Pelacak Air</button></li>
        </ul>
                ...
                <div class="row g-4">
                    <div class="col-6 col-md-3">
                        <div class="card-latihan">
                            <span class="badge bg-light text-dark mb-2 mx-auto rounded-pill px-3 shadow-sm"
                                style="width: max-content;">PILATES 5</span>
                            ...
                            <a href="tantangan.php" class="btn btn-mulai text-decoration-none d-block">MULAI</a>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="card-latihan">
                            <span class="badge bg-light text-dark mb-2 mx-auto rounded-pill px-3 shadow-sm"
                                style="width: max-content;">YOGA</span>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-center py-3">
                                <i class="bi bi-person-hearts text-muted" style="font-size: 4rem;"></i>
                            </div>
                            <a href="yoga.php" class="btn btn-mulai text-decoration-none d-block">MULAI</a>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="card-latihan">
                            <span class="badge bg-light text-dark mb-2 mx-auto rounded-pill px-3 shadow-sm"
                                style="width: max-content;">WORKOUT</span>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-center py-3">
                                <i class="bi bi-person-workspace text-muted" style="font-size: 4rem;"></i>
                            </div>
                            <a href="workout.php" class="btn btn-mulai text-decoration-none d-block">MULAI</a>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="card-latihan">
                            <span class="badge bg-light text-dark mb-2 mx-auto rounded-pill px-3 shadow-sm"
                                style="width: max-content;">SENAM</span>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-center py-3">
                                <i class="bi bi-person-arms-up text-muted" style="font-size: 4rem;"></i>
                            </div>
                            <a href="senam.php" class="btn btn-mulai text-decoration-none d-block">MULAI</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="fokus" role="tabpanel">
                <div class="row g-4 justify-content-center pt-3">
                    ...
                    <div class="col-6 col-md-3 text-center">
                        <a href="fokus_tubuh.php?kategori=Seluruh Tubuh"
                            class="text-decoration-none text-dark body-focus-link">
                            <div class="focus-circle mx-auto mb-3">
                                <img src="https://images.unsplash.com/photo-1518611012118-696072aa579a?w=500&q=80"
                                    alt="Seluruh tubuh">
                            </div>
                    ...
                    <div class="col-6 col-md-3 text-center">
                        <a href="fokus_tubuh.php?kategori=Otot Perut"
                            class="text-decoration-none text-dark body-focus-link">
                            <div class="focus-circle mx-auto mb-3">
                                <img src="https://images.unsplash.com/photo-1507398941214-572c25f4b1dc?w=500&q=80"
                                    alt="Otot perut">
                            </div>
                    ...
                    <div class="col-6 col-md-3 text-center">
                        <a href="fokus_tubuh.php?kategori=Lengan"
                            class="text-decoration-none text-dark body-focus-link">
                            <div class="focus-circle mx-auto mb-3">
                                <img src="https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=500&q=80"
                                    alt="Lengan">
                            </div>
                    ...
                    <div class="col-6 col-md-3 text-center">
                        <a href="fokus_tubuh.php?kategori=Pinggul Kaki"
                            class="text-decoration-none text-dark body-focus-link">
                            <div class="focus-circle mx-auto mb-3">
                                <img src="https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=500&q=80"
                                    alt="Pinggul & Kaki">
                            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-5 text-center mb-4 mb-md-0">
                            <div class="glass-circle mb-4">
                                ...
                                <span class="glass-text" id="glass-count">0 / 8<br><small class="fw-medium text-muted"
                                        style="font-size: 1rem;">gelas</small></span>
                            </div>
                            <div class="d-flex justify-content-center gap-3">
                                <button id="reset-water-btn" class="btn btn-light rounded-circle shadow-sm"
                                    style="width: 50px; height: 50px;"><i
                                        class="bi bi-arrow-counterclockwise fs-5"></i></button>
                                <button id="add-water-btn" class="btn btn-primary-custom rounded-circle shadow"
                                    style="width: 60px; height: 60px; font-size: 24px;">+</button>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="p-4 rounded-4"
                                style="background-color: var(--color-bg); border: 1px dashed var(--color-primary);">
                                ...
                                <p class="text-muted mb-4">Awali harimu dengan hidrasi yang cukup untuk menjaga
                                    metabolisme tubuh.</p>
                                <div
                                    class="d-flex justify-content-between align-items-center p-3 rounded-3 bg-white shadow-sm">
                                    <div class="d-flex align-items-center gap-2">
                                        <i class="bi bi-cup-straw"
                                            style="color: var(--color-secondary); font-size: 1.5rem;"></i>
                                        <div>
                                            <small class="text-muted d-block" style="line-height: 1;">Volume per
                                                gelas</small>
